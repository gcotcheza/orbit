...
// Where you can go from the Netherlands — the short-haul curated set
// (docs/BUSINESS-LOGIC.md §1, §11, §36).
...
return [
    ...
    // Düsseldorf is over the border, ninety minutes from Eindhoven and cheaper.
