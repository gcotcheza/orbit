...
- **The rows carry no tone colour.** There is no round-trip deal score yet (`docs/PLAN.md`, returns-3); until there is, nothing on this section may be tinted good/warn, because the only honest colour for an unscored price is none.
