...
/**
 * The relative lane's arithmetic, hand-computed — `RouteBaseline` is a pure
 * value (docs/BUSINESS-LOGIC.md §16).
 */
final class RouteBaselineTest extends TestCase
{
    ...
    {
        // DUS-AGP real fare: upper of the two cases the 0.40 verification
        // threshold sits below (docs/BUSINESS-LOGIC.md §16).
     ...
     * MEDIAN fare for its distance (docs/BUSINESS-LOGIC.md §16).
     */
    #[Test]
    ...
    /**
     * DO NOT remove the zero-median guard: the alternative is INF, which
     * sorts to the TOP of rankings (docs/BUSINESS-LOGIC.md §16).
     */
    #[Test]
    ...
    /**
     * Saving clamps at 0 (discount doesn't) — "€-12 under its usual" can't
     * print on a card (docs/BUSINESS-LOGIC.md §16).
     */
    #[Test]
