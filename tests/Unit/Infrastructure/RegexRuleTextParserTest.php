 ...
 *
 * The first test is the contract — design/README.md §4's example sentence
 * must produce its six chips exactly; this app ships that sentence pre-typed.
 * Why: docs/BUSINESS-LOGIC.md §36.
 *
 * Loads the real config/orbit.php, not a test vocabulary — the claim is
 * that production's words can read it, not just some regex can.
 * Why: docs/BUSINESS-LOGIC.md §36.
 *
 * A plain PHPUnit TestCase, no database — the whole reason
 * App\Domain\Rules\RuleVocabulary exists.
 * Why: docs/BUSINESS-LOGIC.md §36.
 */
final class RegexRuleTextParserTest extends TestCase
{
    ...
    public function the_designs_own_sentence_produces_the_criteria_behind_those_chips(): void
    {
        ...
        // FRIDAY ALONE: a named day refines "weekend" rather than joining it,
        // so weekend + Friday narrows to Friday, not Friday-and-Saturday.
        // Why: docs/BUSINESS-LOGIC.md §36.
    ...
    public static function prices(): array
    {
        return [
            ...
            // A BARE NUMBER IS NEVER A PRICE: "3 nights" shares sentences with
            // real prices, so a naive reader would turn trip length into a price.
            // Why: docs/BUSINESS-LOGIC.md §36.
    ...
    public static function origins(): array
    {
        return [
            ...
            // Silence is not "all three chips": empty means all-three once MATCHED
            // (RuleCriteria::originsOrAll), but understanding must not overclaim.
            // Why: docs/BUSINESS-LOGIC.md §36.
    ...
    public static function vibes(): array
    {
        return [
            ...
            // "sun" is vocabulary and "sunny" contains it — whole-word matching keeps
            // that from being two vibes (and "mar" out of "market").
            // Why: docs/BUSINESS-LOGIC.md §36.
