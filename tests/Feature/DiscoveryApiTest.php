...
final class DiscoveryApiTest extends TestCase
{
    ...
    /**
     * The lane is published as the enum's string: a relative price needs "rare
     * for this route" or it looks arbitrary (docs/BUSINESS-LOGIC.md §16).
     */
    #[Test]
     ...
     * every threshold is a floor, not a quota (docs/BUSINESS-LOGIC.md §16).
     */
    #[Test]
